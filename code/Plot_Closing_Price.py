...
data_open_n = data_normal[:1200,3]
...
with session as sess:
    ...
    saver.restore(session, '/home/xxxxxx/Final_model_lstm_close')
...
np.save("ClosingPrice.npy",re_)
plt.plot(re_, label='predict')
plt.plot(data[num_steps:max_steps+num_steps,3], label='real')
plt.legend(loc='upper right')
plt.title('Yuan Da Taiwan 50- Closing Price')
plt.xlabel('day')
plt.ylabel('price')
plt.show()
