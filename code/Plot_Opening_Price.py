...
with session as sess:
    ...
    saver.restore(session, '/home/xxxxxx/Final_model_lstm')
...
np.save("OpeningPrice.npy",re_)
plt.plot(re_, label='predict')
plt.plot(data[num_steps:max_steps+num_steps,0], label='real')
plt.legend(loc='upper right')
plt.title('Yuan Da Taiwan 50- Opening Price')
plt.xlabel('day')
plt.ylabel('price')
plt.show()
